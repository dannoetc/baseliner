...
from win32ctypes.core import _backend, _common, _dll, _resource, _system_information, _time
...
def EnumResourceNames(hModule, resType):
    ...
    with _pywin32error():
        _resource._EnumResourceNames(hModule, resType, _resource.ENUMRESNAMEPROC(callback), 0)
...
def UpdateResource(handle, type, name, data, language=LANG_NEUTRAL):
    ...
    with _pywin32error():
        ...
        _resource._UpdateResource(handle, type, name, language, lp_data, len(lp_data))
