...
#
import ctypes
from ctypes.wintypes import BOOL, DWORD, HANDLE, HGLOBAL, HMODULE, HRSRC, LPCWSTR, LPVOID, WORD

from ._common import IS_INTRESOURCE, LONG_PTR
from ._util import check_false, check_null, check_zero, dlls, function_factory
...
_EnumResourceTypes = function_factory(
    dlls.kernel32.EnumResourceTypesW, [HMODULE, _ENUMRESTYPEPROC, LONG_PTR], BOOL, check_false
)

_LoadResource = function_factory(dlls.kernel32.LoadResource, [HMODULE, HRSRC], HGLOBAL, check_null)

_LockResource = function_factory(dlls.kernel32.LockResource, [HGLOBAL], LPVOID, check_null)
...
_BaseFindResourceEx = function_factory(
    dlls.kernel32.FindResourceExW, [HMODULE, LPCWSTR, LPCWSTR, WORD], HRSRC, check_null
)
