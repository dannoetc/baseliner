...
from ._util import check_false, dlls, ffi
...
def _CredDelete(TargetName, Type, Flags):
    return check_false(
        dlls.advapi32.CredDeleteW(make_unicode(TargetName), Type, Flags), "CredDelete"
    )
...
def _CredEnumerate(Filter, Flags, Count, pppCredential):
    ...
    return check_false(
        dlls.advapi32.CredEnumerateW(filter, Flags, Count, pppCredential), "CredEnumerate"
    )
