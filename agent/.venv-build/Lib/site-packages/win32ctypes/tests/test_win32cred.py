...
class TestCred(unittest.TestCase):
    ...
    def test_write_to_pywin32(self):
        ...
        # when
        credentials = win32cred.CredRead(TargetName=target, Type=CRED_TYPE_GENERIC)
        ...
        self.assertEqual(credentials["Comment"], "Created by MiniPyWin32Cred test suite")
        ...
        self.assertEqual(credentials["CredentialBlob"].decode("utf-16"), "doefsajfsakfj")
