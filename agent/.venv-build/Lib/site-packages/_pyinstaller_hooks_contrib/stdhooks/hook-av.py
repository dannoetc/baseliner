...
from PyInstaller.utils.hooks import collect_submodules, get_package_paths, is_module_satisfies
...
if is_module_satisfies("av >= 9.1.1") and is_win:
    ...
    if os.path.isdir(lib_dir):
        ...
        datas = [(os.path.join(lib_dir, lib_file), "av.libs") for lib_file in os.listdir(lib_dir)]
