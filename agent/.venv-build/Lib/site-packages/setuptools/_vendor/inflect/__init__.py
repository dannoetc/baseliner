...
class engine:
    ...
    def _pl_check_plurals_adj(self, word1: str, word2: str) -> bool:
        ...
        return (
            ...
            and bool(word2a)
            and (
                self._pl_check_plurals_N(word1a, word2a) or self._pl_check_plurals_N(word2a, word1a)
            )
        )
    ...
    def _plnoun(  # noqa: C901
        ...
        if (" ".join(dash_split[-2:])).lower() in pl_sb_irregular_compound:
            ...
            return (
                f"{word[:-llen]}" f"{pl_sb_irregular_compound[(' '.join(dash_split[-2:])).lower()]}"
            )
    ...
    def number_to_words(  # noqa: C901
        ...
        valout = ", ".join(numchunks) if group else "".join(self._render(numchunks, decimal, comma))
