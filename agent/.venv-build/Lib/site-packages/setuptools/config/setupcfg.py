...
class ConfigHandler(Generic[Target]):
    ...
    def parsers(self):
        ...
        raise NotImplementedError(f"{self.__class__.__name__} must provide .parsers property")
    ...
    def _exclude_files_parser(cls, key):
        ...
        def parser(value):
            ...
            if value.startswith(exclude_directive):
                raise ValueError(
                    f"Only strings are accepted for the {key} field, " "files are not accepted"
                )
    ...
    def _parse_version(self, value):
        ...
        if version != value:
            ...
            try:
                ...
                raise OptionError(
                    f"Version loaded from {value} does not " f"comply with PEP 440: {version}"
                ) from e
