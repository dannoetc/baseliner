...
class PlatformInfo:
    ...
    def cross_dir(self, forcex86=False):
        ...
        return (
            "" if self.target_cpu == current else self.target_dir().replace("\\", f"\\{current}_")
        )
...
class SystemInfo:
    ...
    def VSInstallDir(self):
        ...
        """
        # Default path
        default = os.path.join(self.ProgramFilesx86, f"Microsoft Visual Studio {self.vs_ver:0.1f}")
