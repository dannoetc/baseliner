...
class Wheel:
    ...
    def _convert_metadata(zf, destination_eggdir, dist_info, egg_info):
        ...
        install_requires, extras_require = Wheel._convert_requires(destination_eggdir, dist_info)
    ...
    def _convert_requires(destination_eggdir, dist_info):
        ...
        install_requires = list(map(raw_req, filter(eval, itertools.filterfalse(for_extra, reqs))))
        extras_require = {
            extra: list(
                map(
                    raw_req,
