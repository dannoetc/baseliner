...
class SignatureDatabase:
    ...
    def generate_ep_signature(self, pe, name, sig_length=512):
        ...
        return self.__generate_signature(pe, offset, name, ep_only=True, sig_length=sig_length)
    ...
    def __match(self, pe, ep_only, section_start_only):
        ...
        for idx in scan_addresses:
            result = self.__match_signature_tree(signatures, data[idx : idx + self.max_depth])
            if result:
