...
class ModuleHook:
    ...
    def __init__(
        self, module_graph, module_name, hook_filename, hook_module_name_prefix, default_priority
    ):
        """
            ...
            for line in f:
                ...
                if m is not None:
                    try:
                        ...
                        logger.warning(
                            "Failed to parse hook priority value string: %r!",
                            m.group("value"),
                            exc_info=True,
                        )
    ...
    def _process_hook_func(self, analysis):
        ...
        hook_api = PostGraphAPI(
            module_name=self.module_name, module_graph=self.module_graph, analysis=analysis
        )
        try:
