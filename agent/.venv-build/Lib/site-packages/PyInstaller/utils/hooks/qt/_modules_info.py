...
QT_MODULES_INFO = (
    ...
    _QtModuleDef(
        "Qt3DRender",
        shared_lib="3DRender",
        plugins=["geometryloaders", "renderplugins", "renderers", "sceneparsers"],
    ),
    # *** qt/qtactiveqt ***
    ...
    _QtModuleDef(
        "QtNetwork", shared_lib="Network", plugins=["bearer"], bindings=["PySide2", "PyQt5"]
    ),
    _QtModuleDef(
        "QtNetwork",
        shared_lib="Network",
    ...
    _QtModuleDef(
        "QtQuick", shared_lib="Quick", plugins=["scenegraph"], bindings=["PySide6", "PyQt6"]
    ),
    ...
    _QtModuleDef(
        None, translations=["qtquickcontrols2"], shared_lib="QuickControls2", bindings=["PyQt5"]
    ),
    _QtModuleDef(
        "QtQuickControls2",
        translations=["qtquickcontrols2"],
        shared_lib="QuickControls2",
        bindings=["PySide2"],
    ),
    # *** qt/qtremoteobjects ***
    ...
    _QtModuleDef(
        "QtXmlPatterns",
        shared_lib="XmlPatterns",
        translations=["qtxmlpatterns"],
        bindings=["PySide2", "PyQt5"],
    ),
    # *** qscintilla ***
