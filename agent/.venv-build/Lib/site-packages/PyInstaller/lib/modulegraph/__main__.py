...
def parse_arguments():
    ...
    parser.add_argument(
        "-g", "--dot", action="store_const", dest="output", const="dot", help="Output a .dot graph"
    )
    parser.add_argument(
        "-h", "--html", action="store_const", dest="output", const="html", help="Output a HTML file"
    )
...
def main():
    ...
    mf = create_graph(opts.scripts, opts.domods, opts.debug, opts.excludes, opts.addpath)
