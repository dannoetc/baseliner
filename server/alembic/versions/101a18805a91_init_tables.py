...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_policy_assignments_device_id", "policy_assignments", ["device_id"], unique=False
    )
    op.create_index(
        "ix_policy_assignments_policy_id", "policy_assignments", ["policy_id"], unique=False
    )
    op.create_table(
        "runs",
        sa.Column("id", sa.UUID(), nullable=False),
        ...
        sa.Column(
            "status",
            sa.Enum("running", "succeeded", "failed", "partial", name="runstatus"),
            nullable=False,
        ),
        sa.Column("agent_version", sa.String(length=64), nullable=True),
    ...
    op.create_index(
        "ix_runs_device_id_started_at", "runs", ["device_id", "started_at"], unique=False
    )
    op.create_table(
        "run_items",
        sa.Column("id", sa.UUID(), nullable=False),
        ...
        sa.Column(
            "status_detect",
            sa.Enum("not_run", "ok", "fail", "skipped", name="stepstatus"),
            nullable=False,
        ),
        sa.Column(
            "status_remediate",
    ...
    op.create_index(
        "ix_run_items_resource_type_id", "run_items", ["resource_type", "resource_id"], unique=False
    )
